 ...
 <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <div class="card shadow mb-4">
          ...
          <p class="btn btn-success">{{Session::get('added')}}</p>
              @endif
            <form method="POST" action="{{ url('admin/services/save') }}">
                @csrf
                <div class="form-row">
      ...
      <div class="col-lg-6">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Your services</h6>
          </div>
          <div class="card-body">
              @error('delete-error')
            ...
            <div class="mycategory">
                <a href="#" class="btn btn-success btn-icon-split">
                    ...
                    <span class="text">{{$services->name}}</span>
                  </a>
            </div>


            <div class="mybutton">
                <a data-toggle="modal"  data-target='#category{{$services->id}}'  href="#" class="btn btn-danger " type="button">Delete <i class="fas fa-trash-alt"></i></a>
                <a href="{{url('admin/services/edit/'.$services->id)}}" class="btn btn-info">Edit <i class="fas fa-edit"></i></a>
            </div>
            <div class="my-2"></div>
